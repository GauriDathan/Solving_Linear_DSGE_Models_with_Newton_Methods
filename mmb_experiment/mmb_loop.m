%Description: 
%General: This is the main file that runs the mmb experiment with the
%zero matrix as starting guess
...
%loop solves each model using Dynare and all Newton methods and stores
%results in big matrix
for loop_k=1:loop_n
    [loop_k loop_k/loop_n]
%change directory to folder path in mmb collection

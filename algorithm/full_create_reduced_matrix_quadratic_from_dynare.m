function [matrix_quadratic, jacobia_]=full_create_reduced_matrix_quadratic_from_dynare(M_,oo_,varargin)
% Uses different snippets of code from Dynare to generate the matrices of
% the matrix quadratic using Dynare parser output
%
%
% ALGORITHMS
...
%[~,jacobia_] = feval([M_.fname '.dynamic'],z(iyr0),exo_simul, M_.params, oo_.dr.ys, it_);
